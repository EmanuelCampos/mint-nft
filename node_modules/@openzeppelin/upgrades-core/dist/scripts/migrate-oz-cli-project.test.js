...
ava_1.default('zosversion', t => {
    const migratableDataZosVersion = { zosversion: '2.2', ...migratableData };
    delete migratableDataZosVersion.manifestVersion;
    const output = migrate_oz_cli_project_1.migrateManifestsData({ rinkeby: migratableDataZosVersion });
    t.true(compare_versions_1.compare(output.newManifestsData.rinkeby.manifestVersion, '3.0', '>='));
});
