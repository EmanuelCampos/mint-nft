...
ava_1.default('same code different formatting produces different metadata', async (t) => {
    ...
    t.not(version_1.hashBytecode(GreeterBytecode), version_1.hashBytecode(GreeterDifferentFormattingBytecode));
    t.is(version_1.hashBytecodeWithoutMetadata(GreeterBytecode), version_1.hashBytecodeWithoutMetadata(GreeterDifferentFormattingBytecode));
});
ava_1.default('removes metadata from Solidity 0.4 bytecode', t => {
    ...
    t.is(version_1.hashBytecodeWithoutMetadata(bytecode), version_1.hashBytecode(`0x${contractBytecode}`));
});
ava_1.default('removes metadata from Solidity ^0.5.9 bytecode', t => {
...
ava_1.default('does not change the bytecode if metadata encoding is invalid', t => {
    const swarmHash = '69b1869ae52f674ffccdd8f6d35de04d578a778e919a1b41b7a2177668e08e1a';
    ...
    t.is(version_1.hashBytecodeWithoutMetadata(bytecode), version_1.hashBytecode(bytecode));
});
ava_1.default('does not change the bytecode if metadata length is not reliable', t => {
    const swarmHash = '69b1869ae52f674ffccdd8f6d35de04d578a778e919a1b41b7a2177668e08e1a';
